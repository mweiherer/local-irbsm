# This script is a slight adaption of the original 'demo.py'
# (https://github.com/facebookresearch/vggsfm/blob/main/demo.py) 
# contained in the VGGSfM GitHub repository.
...
@hydra.main(config_path="../extern/vggsfm/cfgs/", config_name="demo")
def demo_fn(cfg: DictConfig):
    ...
    # Save predictions to output directory, but exclude 'pycolmap.Reconstruction' object.
    torch.save({i : predictions[i] for i in predictions if i != 'reconstruction'},
               output_dir + '/vggsfm_predictions.pt')
