...
def main(args, cfg):
    ...
    if args.ckpt:
        ...
        wandb.init(dir = wandb_dir, config = cfg, project = 'local-iRBSM', resume = 'must', id = run_id)
    else: 
        checkpoint = None
        wandb.init(dir = wandb_dir, config = cfg, project = 'local-iRBSM')
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--num_epochs', type = int,
                           help = 'Number of epochs to train.', default = 15_000) 
